  ...
  return (
    <Card
      ...
      title={
        ...
        >
          <ProjectOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
      ...
      extra={
        <Button onClick={() => list("tasks")} icon={<RightCircleOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />}>
          See kanban board
        </Button>
      }
    >
